...
//计算日期 差 刷卡日 减去 账单日 = date2 - date1  下个月账单日
function calb2(date1, date2) {
...
//		var xxx = calb(stday, eday);
		...
		html += '<div class="cardList">' +
			...
			'<li class="mui-table-view-cell">今日距离账单日<label class="ftbd">' + days2 + '</label>天</li>' +
